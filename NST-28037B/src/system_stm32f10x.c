...
#if defined (STM32F10X_LD_VL) || defined (STM32F10X_LD) || (defined STM32F10X_MD_VL) || (defined STM32F10X_HD_VL)
...
#define VECT_TAB_OFFSET  0x800	/*!< Vector Table base offset field. 
...
static void SetSysClockToHSE(void)
{
	...
	if ((RCC->CR & RCC_CR_HSERDY) != RESET)
	{
		...
		FLASH->ACR &= (uint32_t)((uint32_t)~FLASH_ACR_LATENCY);	/* Flash 0 wait state */
